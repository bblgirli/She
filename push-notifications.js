(()=>{
  // app.js has a legacy in-page Notification() path which replays Firestore
  // changes when a chat listener is created. Push notifications are delivered
  // by the service worker now, so suppress only that legacy page-level path.
