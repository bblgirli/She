(()=>{
  ...
  // Registration is now NEVER automatic. Loading any app/page does not touch
  // notification permissions, Firebase pushSubscriptions, or notification UI.
  // It only runs when the user explicitly enables notifications.
