...
(()=>{
  ...
  function installFastOpen(){
    ...
    window.openChat=(uid)=>{
      ...
      if(current===uid){window.location.href='chat.html';return}
      localStorage.setItem('currentChatUid',uid);
      /* Do not wait for Firestore before navigation. chat.html will resolve the name. */
      window.location.href='chat.html';
      /* Keep the original function available without blocking navigation. */
      void original;
    };
  }
  function boot(){
